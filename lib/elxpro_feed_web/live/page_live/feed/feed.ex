  ...
  def post_comment_form(assigns) do
    ...
    >
      ...
      <footer class="max-h-0 invisible group-focus-within:visible group-focus-within:max-h-[none]">
        <button
          type="submit"
          class="px-4 py-6 mt-4 rounded-lg bg-blue-900 not:disabled:hover:bg-blue-800 text-white font-bold cursor-pointer transition disabled:opacity-70 disabled:cursor-not-allowed"
        >
          Make a Comment
        </button>
      </footer>
