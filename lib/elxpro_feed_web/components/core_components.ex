defmodule ElxproFeedWeb.CoreComponents do
  @moduledoc """
  ...
  def flash(assigns) do
    ...
    <div
      ...
      class={[
        ...
        @kind == :info && "bg-emerald-50 text-emerald-800 ring-emerald-500 fill-blue-900",
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ElxproFeedWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ElxproFeedWeb.Gettext, "errors", msg, opts)
    end
  end
